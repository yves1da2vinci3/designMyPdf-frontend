...
export default function Login() {
  ...
  return (
    <Grid gutter={0} style={{ minHeight: '100vh' }}>
      ...
      >
        ...
        >
          ...
          <Text size="sm" c="dimmed" mb="xl">
            Join thousands of developers and enterprises automating their document workflow with surgical precision.
          </Text>
            ...
            {FEATURES.map((f) => (
              <Grid.Col key={f.title} span={6}>
                ...
                >
                  ...
                  <Text fw={600} size="sm" mb={2}>{f.title}</Text>
      ...
      >
        <Box style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
          <Box style={{ maxWidth: 440, width: '100%' }}>
            <Title order={2} fw={700} mb={4}>Welcome back</Title>
            <Text size="sm" c="dimmed" mb="xl">
            ...
            <Divider
              my="xl"
              label={
                <Text size="xs" fw={600} tt="uppercase" style={{ letterSpacing: '0.08em' }} c="dimmed">
                  Or continue with
                </Text>
              }
            ...
            <Grid gutter="sm">
              <Grid.Col span={6}>
                <Button variant="default" fullWidth leftSection={
        ...
        <Group justify="flex-end" gap="lg" mt="xl">
          <Anchor size="xs" c="dimmed">Support</Anchor>
